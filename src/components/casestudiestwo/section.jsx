...
const HeroSection = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/assets/img/herowebp/casestudies.webp')" }}
    >
      {/* Inner content */}
      <div className="tw-flex  tw-h-1/2 tw-px-2 md:tw-px-0 tw-w-full tw-flex-col tw-gap-2 tw-items-center tw-justify-end">
        <h1 className="tw-text-white tw-text-4xl md:tw-text-5xl tw-font-bold tw-text-center">
          {title}
        </h1>
        <p className="tw-text-white tw-text-center">{text}</p>
